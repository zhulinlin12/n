...
angular.module('request')
    .controller('cgs01-shangpuxiangqing', ['$scope', '$http','$state', 'commonHttp', function($scope, $http,$state, commonHttp) {
//        alert(11)
        if(localStorage.id){
        ...
        var str=JSON.stringify({  // 将输出参数转为json字符
            "shop": {     //??
                ...
                channel : "pc",
                deviceNo : "",
                functionCode : "SHOPDETAILS",
                shopId : 'a2c2f708b83d4dcb8301f412757c3af1',
                startRow : "0",
                pageSize : "999",
            }
        });
